...
function Renovation() {
    ...
    const texts = {
        ar: {
            card_title_hero: "أعمال الترميم والتجديد",
            card_text_hero: "تعد صيت السعودية للمقاولات شريكك الموثوق في تنفيذ مشاريع الترميم والتجديد باحترافية عالية، حيث نقدم حلولاً متكاملة لإعادة تأهيل المباني القديمة وتحسينها لتلبي أعلى معايير الجودة والجمال. نحن متخصصون في تجديد الواجهات، تحسين التصميمات الداخلية، وتقوية الهياكل الإنشائية.",
            about_services: "نحن نوفر خدمات الترميم والتجديد باستخدام أحدث التقنيات وأفضل المواد لضمان الجودة، المتانة، والمظهر العصري للمباني."
        },
        en: {
            card_title_hero: "Renovation & Restoration",
            card_text_hero: "At Saudit Contracting, we are your trusted partner in executing high-quality renovation and restoration projects, offering comprehensive solutions to rehabilitate and enhance old buildings while meeting the highest standards of quality and aesthetics. We specialize in facade renovations, interior upgrades, and structural reinforcements.",
            about_services: "We provide renovation and restoration services using the latest technologies and premium materials to ensure quality, durability, and a modern appearance for buildings."
        }
    };
    const settings = {
        dots: false,
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src={renovation} className="img-fluid rounded-start" alt="..." />
                            </div>
