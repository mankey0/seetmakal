...
function Steelworks() {
    ...
    const texts = {
        ar: {
            card_title_hero: "أعمال الحدادة الخرسانية",
            card_text_hero: "تعد صيت السعودية للمقاولات شريكك الموثوق في تنفيذ أعمال الحدادة الخرسانية، حيث نقدم حلولاً متكاملة تلبي أعلى معايير الجودة والسلامة. نحن متخصصون في تركيب الحديد المسلح لجميع أنواع المنشآت، مما يضمن المتانة والقوة الإنشائية وفقاً لأفضل المعايير الهندسية.",
            about_services: "نحن نوفر خدمات الحدادة الخرسانية باستخدام أحدث التقنيات والمواد عالية الجودة لضمان قوة ومتانة الهياكل الخرسانية."
        },
        en: {
            card_title_hero: "Steel Reinforcement",
            card_text_hero: "At Saudit Contracting, we are your trusted partner in executing high-quality steel reinforcement works, offering comprehensive solutions that meet the highest standards of quality and safety. We specialize in installing reinforced steel for all types of structures, ensuring durability and structural strength according to top engineering standards.",
            about_services: "We provide steel reinforcement services using the latest technologies and high-quality materials to ensure the strength and durability of concrete structures."
        }
    };
    const settings = {
        dots: false,
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src={steelworks} className="img-fluid rounded-start" alt="..." />
                            </div>
