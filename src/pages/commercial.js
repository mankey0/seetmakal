...
function Commercial() {
  ...
  const texts = {
    ar: {
      card_title_hero: "البناء التجاري",
      card_text_hero: `تعتبر صيت السعودية للمقاولات شريكك الموثوق في مجال الإنشاءات التجارية، حيث نقدم حلول بناء متكاملة تلبي أعلى المعايير الهندسية والتصميمية. نحن متخصصون في تنفيذ المشاريع التجارية مثل المكاتب، المجمعات التجارية، الفنادق، والمباني الإدارية، مع الالتزام بالجودة، الدقة، والتسليم في الوقت المحدد.`,
      about_services: `سواء كنت بحاجة إلى تشييد مبنى جديد أو تجديد منشأة قائمة، فإن فريقنا من المهندسين والخبراء مستعد لتحويل رؤيتك إلى واقع باستخدام أحدث التقنيات والمواد عالية الجودة.`,

    },
    en: {
      card_title_hero: "Commercial Construction",
      card_text_hero: `This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer. `,
      about_services: `Whether you need to construct a new building or renovate an existing facility, our team of engineers and experts is ready to bring your vision to life using the latest technologies and high-quality materials.`,
          ...
          <div className="card mb-3">
            <div className="row g-0">
              <div className="col-md-4">
                <img src={Construction} className="img-fluid rounded-start" alt="..." />
              </div>
