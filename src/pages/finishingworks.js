...
function Finishingworks() {
    ...
    const texts = {
        ar: {
            card_title_hero: "أعمال التشطيبات النهائية",
            card_text_hero: "تعد صيت السعودية للمقاولات شريكك الموثوق في تنفيذ أعمال التشطيبات النهائية بأعلى معايير الجودة والدقة، حيث نقدم حلولاً متكاملة لإضافة اللمسات الأخيرة على المباني من الدهانات، الأرضيات، الأسقف، والديكورات الداخلية والخارجية.",
            about_services: "نحن نوفر خدمات التشطيبات النهائية باستخدام أحدث التقنيات وأجود المواد لضمان مظهر راقٍ وجودة تدوم طويلاً."
        },
        en: {
            card_title_hero: "Final Finishing Works",
            card_text_hero: "At Saudit Contracting, we are your trusted partner in executing high-quality final finishing works, offering comprehensive solutions to enhance buildings with premium painting, flooring, ceilings, and both interior and exterior decorations.",
            about_services: "We provide final finishing services using the latest technologies and finest materials to ensure a luxurious appearance and long-lasting quality."
        }
    };
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src={finishingworks} className="img-fluid rounded-start" alt="..." />
                            </div>
