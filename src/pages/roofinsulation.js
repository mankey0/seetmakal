...
function Roofinsulation() {
    ...
    const texts = {
        ar: {
            card_title_hero: "عزل الأسطح وتركيب التكييف المركزي",
            card_text_hero: "تعد صيت السعودية للمقاولات شريكك الموثوق في تنفيذ أعمال عزل الأسطح وتركيب التكييف المركزي، حيث نقدم حلولاً متكاملة لحماية المباني من العوامل البيئية وتعزيز كفاءة الطاقة بأنظمة تكييف متطورة.",
            about_services: "نحن نوفر خدمات العزل والتكييف باستخدام أحدث التقنيات وأجود المواد لضمان عزل حراري ومائي فعال وتحقيق أقصى درجات الراحة والاستدامة."
        },
        en: {
            card_title_hero: "Roof Insulation & Central AC Installation",
            card_text_hero: "At Saudit Contracting, we are your trusted partner in executing high-quality roof insulation and central AC installation, providing comprehensive solutions to protect buildings from environmental factors and enhance energy efficiency with advanced air conditioning systems.",
            about_services: "We provide insulation and AC installation services using the latest technologies and highest-quality materials to ensure effective thermal and waterproofing, maximizing comfort and sustainability."
        }
    };
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src={roofinsulation} className="img-fluid rounded-start" alt="..." />
                            </div>
