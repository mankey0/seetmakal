...
function Gypsum() {
    ...
    const texts = {
        ar: {
            card_title_hero: "تركيب الأسقف الجبسية",
            card_text_hero: "تعد صيت السعودية للمقاولات شريكك الموثوق في تنفيذ وتركيب الأسقف الجبسية بأعلى معايير الجودة والاحترافية، حيث نقدم تصاميم مبتكرة وحلولًا متكاملة تناسب مختلف أنواع المباني، مع ضمان التشطيب المثالي والدقة في التنفيذ.",
            about_services: "نحن نوفر خدمات تركيب الأسقف الجبسية باستخدام أجود المواد وأحدث التقنيات لضمان المتانة، الجمال، والتصاميم العصرية الفريدة."
        },
        en: {
            card_title_hero: "Gypsum Ceiling Installation",
            card_text_hero: "At Saudit Contracting, we are your trusted partner in executing high-quality gypsum ceiling installations, offering innovative designs and comprehensive solutions tailored to different types of buildings, ensuring flawless finishing and precision.",
            about_services: "We provide gypsum ceiling installation services using premium materials and the latest technologies to ensure durability, elegance, and unique modern designs."
        }
    };
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src={gypsum} className="img-fluid rounded-start" alt="..." />
                            </div>
