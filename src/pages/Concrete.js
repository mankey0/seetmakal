...
function Concrete() {
    ...
    const texts = {
        ar: {
            card_title_hero: "أعمال الخرسانة",
            card_text_hero: "تعد صيت السعودية للمقاولات شريكك الموثوق في تنفيذ أعمال الخرسانة باحترافية عالية، حيث نقدم حلولاً متكاملة تلبي أعلى معايير الجودة والمتانة. نحن متخصصون في إنشاء الهياكل الخرسانية، القواعد والأساسات، مع الالتزام بالدقة والتسليم في الوقت المحدد.",
            about_services: "نحن نوفر خدمات الخرسانة باستخدام أحدث التقنيات والمواد عالية الجودة لضمان قوة ومتانة المنشآت الخرسانية."
        },
        en: {
            card_title_hero: "Concrete Works",
            card_text_hero: "At Saudit Contracting, we are your trusted partner in executing high-quality concrete works, offering comprehensive solutions that meet the highest standards of durability and strength. We specialize in constructing concrete structures, foundations, and slabs with a commitment to precision and timely delivery.",
            about_services: "We provide concrete services using the latest technologies and high-quality materials to ensure strength and durability."
        }
    };
    const settings = {
        dots: false,
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src={concrete} className="img-fluid rounded-start" alt="..." />
                            </div>
