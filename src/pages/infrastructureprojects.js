...
function Infrastructureprojects() {
    ...
    const texts = {
        ar: {
            card_title_hero: "مشاريع البنية التحتية",
            card_text_hero: "تعد صيت السعودية للمقاولات شريكك الموثوق في تنفيذ مشاريع البنية التحتية بجودة عالية وفق أعلى المعايير الهندسية. نحن متخصصون في تطوير شبكات الطرق، المياه، الصرف الصحي، والكهرباء لضمان بنية تحتية متينة ومستدامة.",
            about_services: "نحن نوفر حلولاً متكاملة لمشاريع البنية التحتية باستخدام أحدث التقنيات والمواد لضمان كفاءة واستدامة المشاريع على المدى الطويل."
        },
        en: {
            card_title_hero: "Infrastructure Projects",
            card_text_hero: "At Saudit Contracting, we are your trusted partner in executing high-quality infrastructure projects, adhering to the highest engineering standards. We specialize in developing road networks, water systems, sewage, and electrical networks to ensure a robust and sustainable infrastructure.",
            about_services: "We provide comprehensive infrastructure solutions using the latest technologies and materials to ensure efficiency and long-term sustainability."
        }
    };
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src={infrastructureprojects} className="img-fluid rounded-start" alt="..." />
                            </div>
