...
function Aluminumglass() {
    const { language } = useLanguage();
    const texts = {
        ar: {
            card_title_hero: "تركيب الزجاج",
            card_text_hero: "تعد صيت السعودية للمقاولات شريكك الموثوق في تنفيذ أعمال تركيب الزجاج لمختلف التطبيقات الداخلية والخارجية، حيث نقدم حلولاً متكاملة باستخدام أحدث التقنيات لضمان الجودة والجمال.",
            about_services: "نحن نوفر خدمات تركيب الزجاج بجودة عالية، تشمل الواجهات الزجاجية، الأبواب، النوافذ، الفواصل الداخلية، والأسقف الزجاجية، لتحقيق تصاميم عصرية وأنيقة."
        },
        en: {
            card_title_hero: "Glass Installation",
            card_text_hero: "At Saudit Contracting, we are your trusted partner in executing high-quality glass installation for various indoor and outdoor applications, offering comprehensive solutions with the latest technologies to ensure quality and aesthetics.",
            about_services: "We provide premium glass installation services, including glass facades, doors, windows, interior partitions, and glass ceilings, to achieve modern and elegant designs."
        }
    };
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src={aluminumglass} className="img-fluid rounded-start" alt="..." />
                            </div>
