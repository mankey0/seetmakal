...
function Plastering() {
    ...
    const texts = {
        ar: {
            card_title_hero: "أعمال اللياسة",
            card_text_hero: "تعد صيت السعودية للمقاولات شريكك الموثوق في تنفيذ أعمال اللياسة بجودة عالية، حيث نقدم حلولاً متكاملة باستخدام أحدث التقنيات لضمان تشطيبات مثالية. نحن متخصصون في تنفيذ جميع أنواع اللياسة الداخلية والخارجية بمهارة فائقة للحصول على سطح متناسق وجذاب.",
            about_services: "نحن نوفر خدمات اللياسة باحترافية باستخدام مواد عالية الجودة وتقنيات متطورة لتحقيق أفضل النتائج في التشطيبات."
        },
        en: {
            card_title_hero: "Plastering Works",
            card_text_hero: "At Saudit Contracting, we are your trusted partner in executing high-quality plastering works, offering comprehensive solutions using the latest technologies to ensure flawless finishes. We specialize in applying both interior and exterior plastering with outstanding craftsmanship to achieve smooth and attractive surfaces.",
            about_services: "We provide professional plastering services using high-quality materials and advanced techniques to deliver the best finishing results."
        }
    };
    const settings = {
        dots: false,
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src={plastering} className="img-fluid rounded-start" alt="..." />
                            </div>
