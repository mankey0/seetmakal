...
function Industrial() {
    ...
    const texts = {
        ar: {
            card_title_hero: "المشاريع الصناعية",
            card_text_hero: "تعتبر صيت السعودية للمقاولات شريكك الموثوق في تنفيذ المشاريع الصناعية الكبرى، حيث نقدم حلولاً متكاملة تلبي أعلى المعايير الهندسية والصناعية. نحن متخصصون في إنشاء المصانع، المستودعات، والمنشآت الصناعية مع الالتزام بالجودة، الدقة، والتسليم في الوقت المحدد.",
            about_services: "نحن نوفر خدمات البناء الصناعي باستخدام أحدث التقنيات والمواد عالية الجودة لضمان متانة وكفاءة المنشآت الصناعية.",

        },
        en: {
            card_title_hero: "Industrial Projects",
            card_text_hero: "At Saudit Contracting, we are your trusted partner in executing major industrial projects, offering comprehensive solutions that meet the highest engineering and industrial standards. We specialize in constructing factories, warehouses, and industrial facilities with a commitment to quality, precision, and timely delivery.",
            about_services: "We provide industrial construction services using the latest technologies and high-quality materials to ensure durability and efficiency.",
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src={industrial} className="img-fluid rounded-start" alt="..." />
                            </div>
