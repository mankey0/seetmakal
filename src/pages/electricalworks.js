...
function Electricalworks() {
    ...
    const texts = {
        ar: {
            card_title_hero: "أعمال السباكة والكهرباء",
            card_text_hero: "تعد صيت السعودية للمقاولات شريكك الموثوق في تنفيذ أعمال السباكة والكهرباء بكفاءة عالية، حيث نقدم حلولاً متكاملة تلبي أعلى معايير الجودة والسلامة. نحن متخصصون في تركيب أنظمة السباكة والتوصيلات الكهربائية للمباني السكنية والتجارية والصناعية لضمان الأداء الموثوق والمستدام.",
            about_services: "نحن نوفر خدمات السباكة والكهرباء باستخدام أحدث التقنيات والمواد عالية الجودة لضمان الكفاءة والأمان في جميع المشاريع."
        },
        en: {
            card_title_hero: "Plumbing & Electrical Works",
            card_text_hero: "At Saudit Contracting, we are your trusted partner in executing high-quality plumbing and electrical works, offering comprehensive solutions that meet the highest standards of quality and safety. We specialize in installing plumbing systems and electrical connections for residential, commercial, and industrial buildings to ensure reliable and sustainable performance.",
            about_services: "We provide plumbing and electrical services using the latest technologies and high-quality materials to ensure efficiency and safety in all projects."
        }
    };
    const settings = {
        dots: false,
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src={electricalworks} className="img-fluid rounded-start" alt="..." />
                            </div>
