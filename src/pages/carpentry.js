...
function Carpentry() {
    ...
    const texts = {
        ar: {
            card_title_hero: "أعمال النجارة",
            card_text_hero: "تعد صيت السعودية للمقاولات شريكك الموثوق في تنفيذ أعمال النجارة باحترافية عالية، حيث نقدم حلولاً متكاملة تلبي أعلى معايير الجودة والتصميم. نحن متخصصون في تنفيذ الهياكل الخشبية، الأبواب، النوافذ، والأعمال الخشبية الداخلية والخارجية بدقة متناهية.",
            about_services: "نحن نوفر خدمات النجارة باستخدام أجود أنواع الخشب وأحدث التقنيات لضمان المتانة والجمال في جميع الأعمال الخشبية."
        },
        en: {
            card_title_hero: "Carpentry Works",
            card_text_hero: "At Saudit Contracting, we are your trusted partner in executing high-quality carpentry works, offering comprehensive solutions that meet the highest standards of craftsmanship and design. We specialize in constructing wooden structures, doors, windows, and both interior and exterior woodworks with great precision.",
            about_services: "We provide carpentry services using the finest wood materials and the latest technologies to ensure durability and aesthetic appeal in all woodwork projects."
        }
    };
    const settings = {
        dots: false,
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src={carpentry} className="img-fluid rounded-start" alt="..." />
                            </div>
