...
function Ceramic() {
    ...
    const texts = {
        ar: {
            card_title_hero: "تركيب السيراميك، الرخام، والحجر",
            card_text_hero: "تعد صيت السعودية للمقاولات شريكك الموثوق في تنفيذ أعمال تركيب السيراميك، الرخام، والحجر بأعلى معايير الجودة والدقة. نقدم حلولاً متكاملة لتغطية الأرضيات والجدران بمواد فاخرة تضفي لمسة جمالية ومتانة تدوم طويلاً.",
            about_services: "نحن نوفر خدمات تركيب السيراميك، الرخام، والحجر باستخدام أحدث التقنيات وأفضل المواد لضمان الدقة، المتانة، والجمال في جميع المشاريع."
        },
        en: {
            card_title_hero: "Ceramic, Marble & Stone Installation",
            card_text_hero: "At Saudit Contracting, we are your trusted partner in executing high-quality ceramic, marble, and stone installation works. We offer comprehensive solutions to cover floors and walls with luxurious materials that ensure both aesthetic appeal and long-lasting durability.",
            about_services: "We provide ceramic, marble, and stone installation services using the latest technologies and premium materials to guarantee precision, durability, and elegance in all projects."
        }
    };
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src={ceramic} className="img-fluid rounded-start" alt="..." />
                            </div>
