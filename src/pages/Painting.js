...
function Painting() {
    ...
    const texts = {
        ar: {
            card_title_hero: "أعمال الدهان",
            card_text_hero: "تعد صيت السعودية للمقاولات شريكك الموثوق في تنفيذ أعمال الدهان بمهارة عالية، حيث نقدم حلولاً متكاملة تلبي أعلى معايير الجودة والجمال. نحن متخصصون في تنفيذ جميع أعمال الطلاء والديكور الداخلي والخارجي باستخدام أحدث التقنيات والمواد عالية الجودة.",
            about_services: "نحن نوفر خدمات الدهان باستخدام أفضل أنواع الدهانات والتقنيات الحديثة لضمان مظهر أنيق وحماية طويلة الأمد."
        },
        en: {
            card_title_hero: "Painting Works",
            card_text_hero: "At Saudit Contracting, we are your trusted partner in executing high-quality painting works, offering comprehensive solutions that meet the highest standards of quality and aesthetics. We specialize in all kinds of interior and exterior painting and decorative works using the latest techniques and premium materials.",
            about_services: "We provide painting services using the best-quality paints and modern techniques to ensure an elegant appearance and long-lasting protection."
        }
    };
    const settings = {
        dots: false,
                    ...
                    <div className="card mb-3">
                        <div className="row g-0">
                            <div className="col-md-4">
                                <img src={painting} className="img-fluid rounded-start" alt="..." />
                            </div>
